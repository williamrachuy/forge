...
public class UltronRuntimeStackHookInvalidationTest extends AITest {

    @Test
    public void testHandlePlayingSpellAbilityInvalidatesUltronRuntimeCache() {
        ...
        SpellAbility opt = candidateFromHand("Opt", ultron);
        Assert.assertTrue(ComputerUtil.handlePlayingSpellAbility(ultron, opt, null),
                "Stack-based spell play should succeed and trigger runtime invalidation");
        ...
        Assert.assertTrue(secondDecision.hasChoice(),
                "A real AI stack-based play should refresh cached runtime state");
    ...
    private Game createFourPlayerGame() {
        ...
        Match match = new Match(rules, players, "UltronRuntimeStackHookInvalidationTest");
